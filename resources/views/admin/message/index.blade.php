            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('admin.message.show',['id'=>$rs->id])}}" class="btn btn-outline-primary" onclick="return !window.open(this.href,'','top=50 left=100 width=1100 height=700')" data-toggle="tooltip" title="Show"><i class="bi bi-eye-fill"></i>
                            </a>
                        </td>
                    </tr>
                    @endforeach
